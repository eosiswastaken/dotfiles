...
sudo apt update
sudo apt install stow alacritty sxhkd polybar bottom rofi zsh code zoxide zsh-autosuggestions zsh-syntax-highlighting firefox vlc vim discord tmux entr ripgrep
```

not installable with `apt` : obsidian starship pico-8 spotify tldr eza
